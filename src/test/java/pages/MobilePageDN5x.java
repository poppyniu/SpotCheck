...
public class MobilePageDN5x {
    ...
    @AndroidFindBy(xpath = "//*[@resource-id=\"com.eco.global.app:id/robot_name\"]")
    public MobileElement DN5xRobotName;
    ...
    public MobilePageDN5x(AppiumDriver driver) {
